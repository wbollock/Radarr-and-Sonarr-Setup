# Yet Another Arr Guide

This guide has instructions on creating a full Arr (Radarr, Sonarr, Prowlarr, Deluge, Bazarr, etc) stack with Docker.

*tl;dr* - [docker-compose.yaml](docker-compose.yaml)
...
These guides probably still work, but are antiquated.

* [Docker-compose setup](legacy/Docker-Compose_Setup.md), with conversion/backup/restore instructions
* [Dockerless setups](legacy/Dockerless_Setup.md)
